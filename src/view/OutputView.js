...
const OutputView = {
   ...
   */
  printResult(bridgeState, count, successOrFailure) {
    this.print(INPUT_MESSAGE.result);
    this.printMap(bridgeState);
    this.print(INPUT_MESSAGE.success(successOrFailure));
    this.print(INPUT_MESSAGE.tryCount(count));
  },
};
